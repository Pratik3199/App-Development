...
public class CreateNewExcelFile {
	public static void main(String[] args) throws IOException 
	{
		...
		XSSFWorkbook inputWorkbook1=new XSSFWorkbook(fis);
		int inputSheetCount=inputWorkbook1.getNumberOfSheets();
		...
		for(int i=0;i<inputSheetCount;i++) 
                { 
                  XSSFSheet inputSheet=inputWorkbook1.getSheetAt(i); 
                  String inputSheetName=inputWorkbook1.getSheetName(i); 
                  XSSFSheet outputSheet=outputWorkbook1.createSheet(inputSheetName); 
