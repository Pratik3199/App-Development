...
public class PlanetExplorer {
	...
	public static void main (String [] args) {
		...
		System.out.println("     by: Pratik Singh");
		...
		System.out.println(" on Venus: " + mass.format(massWeightOnVenus) + "Kilogram");
		...
		System.out.println(" on Mars: " + mass.format(massWeightOnMars) + "Kilogram");
		...
		System.out.println(" on Jupiter: " + mass.format(massWeightOnJupiter) + "Kilogram");
		...
		System.out.println(" on Saturn: " + mass.format(massWeightOnSaturn) + "Kilogram");
		...
		System.out.println(" on Uranus: " + mass.format(massWeightOnUranus) + "Kilogram");
		...
		System.out.println(" on Neptune: " + mass.format(massWeightOnNeptune) + "Kilogram");
		...
		System.out.println(" on Pluto: " + mass.format(massWeightOnPluto) + "Kilogram");
	}
}
